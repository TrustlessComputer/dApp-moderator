...
func (u Usecase) CollectionNftContent(ctx context.Context,collectionAddress string, tokenID string) (interface{}, error) {
	
	data, err := u.NftExplorer.CollectionNftContent(collectionAddress, tokenID)
	if err != nil {
