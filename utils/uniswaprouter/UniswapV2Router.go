...
func (_Uniswaprouter *UniswaprouterCaller) Owner(opts *bind.CallOpts) (common.Address, error) {
	var out []interface{}
	err := _Uniswaprouter.contract.Call(opts, &out, "owner")
...
//
// Solidity: function owner() view returns(address)
func (_Uniswaprouter *UniswaprouterSession) Owner() (common.Address, error) {
	return _Uniswaprouter.Contract.Owner(&_Uniswaprouter.CallOpts)
}

// Owner is a free data retrieval call binding the contract method 0x8da5cb5b.
//
// Solidity: function owner() view returns(address)
func (_Uniswaprouter *UniswaprouterCallerSession) Owner() (common.Address, error) {
	return _Uniswaprouter.Contract.Owner(&_Uniswaprouter.CallOpts)
}
...
func (_Uniswaprouter *UniswaprouterTransactor) Initialize(opts *bind.TransactOpts, _factory common.Address, _WETH common.Address) (*types.Transaction, error) {
	return _Uniswaprouter.contract.Transact(opts, "initialize", _factory, _WETH)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address _factory, address _WETH) returns()
func (_Uniswaprouter *UniswaprouterSession) Initialize(_factory common.Address, _WETH common.Address) (*types.Transaction, error) {
	return _Uniswaprouter.Contract.Initialize(&_Uniswaprouter.TransactOpts, _factory, _WETH)
}

// Initialize is a paid mutator transaction binding the contract method 0x485cc955.
//
// Solidity: function initialize(address _factory, address _WETH) returns()
func (_Uniswaprouter *UniswaprouterTransactorSession) Initialize(_factory common.Address, _WETH common.Address) (*types.Transaction, error) {
	return _Uniswaprouter.Contract.Initialize(&_Uniswaprouter.TransactOpts, _factory, _WETH)
}
...
func (_Uniswaprouter *UniswaprouterTransactor) RenounceOwnership(opts *bind.TransactOpts) (*types.Transaction, error) {
	return _Uniswaprouter.contract.Transact(opts, "renounceOwnership")
}

// RenounceOwnership is a paid mutator transaction binding the contract method 0x715018a6.
//
// Solidity: function renounceOwnership() returns()
func (_Uniswaprouter *UniswaprouterSession) RenounceOwnership() (*types.Transaction, error) {
	return _Uniswaprouter.Contract.RenounceOwnership(&_Uniswaprouter.TransactOpts)
}

// RenounceOwnership is a paid mutator transaction binding the contract method 0x715018a6.
//
// Solidity: function renounceOwnership() returns()
func (_Uniswaprouter *UniswaprouterTransactorSession) RenounceOwnership() (*types.Transaction, error) {
	return _Uniswaprouter.Contract.RenounceOwnership(&_Uniswaprouter.TransactOpts)
}
...
func (_Uniswaprouter *UniswaprouterTransactor) TransferOwnership(opts *bind.TransactOpts, newOwner common.Address) (*types.Transaction, error) {
	return _Uniswaprouter.contract.Transact(opts, "transferOwnership", newOwner)
}

// TransferOwnership is a paid mutator transaction binding the contract method 0xf2fde38b.
//
// Solidity: function transferOwnership(address newOwner) returns()
func (_Uniswaprouter *UniswaprouterSession) TransferOwnership(newOwner common.Address) (*types.Transaction, error) {
	return _Uniswaprouter.Contract.TransferOwnership(&_Uniswaprouter.TransactOpts, newOwner)
}

// TransferOwnership is a paid mutator transaction binding the contract method 0xf2fde38b.
//
// Solidity: function transferOwnership(address newOwner) returns()
func (_Uniswaprouter *UniswaprouterTransactorSession) TransferOwnership(newOwner common.Address) (*types.Transaction, error) {
	return _Uniswaprouter.Contract.TransferOwnership(&_Uniswaprouter.TransactOpts, newOwner)
}
...
// UniswaprouterOwnershipTransferredIterator is returned from FilterOwnershipTransferred and is used to iterate over the raw logs and unpacked data for OwnershipTransferred events raised by the Uniswaprouter contract.
type UniswaprouterOwnershipTransferredIterator struct {
	Event *UniswaprouterOwnershipTransferred // Event containing the contract specifics and raw log
...
func (it *UniswaprouterOwnershipTransferredIterator) Next() bool {
	...
	if it.done {
		select {
		case log := <-it.logs:
			it.Event = new(UniswaprouterOwnershipTransferred)
...
func (it *UniswaprouterOwnershipTransferredIterator) Error() error {
	return it.fail
}

// Close terminates the iteration process, releasing any pending underlying
// resources.
func (it *UniswaprouterOwnershipTransferredIterator) Close() error {
	it.sub.Unsubscribe()
	return nil
}

// UniswaprouterOwnershipTransferred represents a OwnershipTransferred event raised by the Uniswaprouter contract.
type UniswaprouterOwnershipTransferred struct {
...
func (_Uniswaprouter *UniswaprouterFilterer) FilterOwnershipTransferred(opts *bind.FilterOpts, previousOwner []common.Address, newOwner []common.Address) (*UniswaprouterOwnershipTransferredIterator, error) {
	...
	logs, sub, err := _Uniswaprouter.contract.FilterLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return &UniswaprouterOwnershipTransferredIterator{contract: _Uniswaprouter.contract, event: "OwnershipTransferred", logs: logs, sub: sub}, nil
}

// WatchOwnershipTransferred is a free log subscription operation binding the contract event 0x8be0079c531659141344cd1fd0a4f28419497f9722a3daafe3b4186f6b6457e0.
//
// Solidity: event OwnershipTransferred(address indexed previousOwner, address indexed newOwner)
func (_Uniswaprouter *UniswaprouterFilterer) WatchOwnershipTransferred(opts *bind.WatchOpts, sink chan<- *UniswaprouterOwnershipTransferred, previousOwner []common.Address, newOwner []common.Address) (event.Subscription, error) {
	...
	logs, sub, err := _Uniswaprouter.contract.WatchLogs(opts, "OwnershipTransferred", previousOwnerRule, newOwnerRule)
	if err != nil {
		return nil, err
	}
	return event.NewSubscription(func(quit <-chan struct{}) error {
		...
		for {
			...
			case log := <-logs:
				...
				event := new(UniswaprouterOwnershipTransferred)
				if err := _Uniswaprouter.contract.UnpackLog(event, "OwnershipTransferred", log); err != nil {
					return err
				}
				event.Raw = log
...
//
// Solidity: event OwnershipTransferred(address indexed previousOwner, address indexed newOwner)
func (_Uniswaprouter *UniswaprouterFilterer) ParseOwnershipTransferred(log types.Log) (*UniswaprouterOwnershipTransferred, error) {
	event := new(UniswaprouterOwnershipTransferred)
	if err := _Uniswaprouter.contract.UnpackLog(event, "OwnershipTransferred", log); err != nil {
		return nil, err
	}
